...
fun main() {
    ...
    val auth: FileManagerAuth? = null //TotpFileManagerAuth()
    ...
    embeddedServer(Netty, configure = {
        // See the matching comment in FileManagerServiceAndroid — kept off here too since this
        // server has no need for HTTP/2 and it keeps desktop/Android behavior consistent.
        enableHttp2 = false
